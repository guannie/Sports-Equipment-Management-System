...
$sql="SELECT idStaff FROM `staff` WHERE idStaff='".$id."'";
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="jumbotron">
                    ...
                    <p><span class="glyphicon glyphicon-trash"></span> &nbsp; DELETE</p><hr>
                    <table width="1000" align="center">
						  ...
						  <tbody>
							<?php 
								$sql="SELECT * FROM equipment WHERE EquipmentQuantity!=0";
							  ...
							  while ($record = mysql_fetch_array($query))
							{
								...
								if(isset($_POST['eid']))
								echo "<TD><button type='button' onclick='window.location.assign(\"deleteform.php?id=".$record["idEquipment"]."&eid=".$id."\")' value='delete'>Delete</button></td>";
								else echo "<TD><button type='button' onclick='window.location.assign(\"deleteform.php?id=".$record["idEquipment"]."&eid=".$id."\")' value='delete'>Delete</button></td>";
								echo "</TR>\n";
							}
							   ?>			
